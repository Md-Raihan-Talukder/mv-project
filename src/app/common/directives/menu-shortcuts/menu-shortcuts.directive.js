(function () {
    ...
    angular
        .module('app.common')
        .controller('msbMenuShortcutsDirectiveController', msbMenuShortcutsDirectiveController)
        .directive('msbMenuShortcuts', msbMenuShortcutsDirective);

    /** @ngInject */
    function msbMenuShortcutsDirectiveController($scope, $cookies, $document, $timeout, $q, msNavigationService) {
        var vm = this;
        ...
        function init() {
            ...
            $scope.$watch('MsbMenuShortcuts.query', function (current, old) {
        ...
        function loadShortcuts() {
            ...
            var shortcuts = angular.fromJson($cookies.get('techdiser.shortcuts'));
            ...
            if (angular.isUndefined(shortcuts)) {
                ...
                $cookies.put('techdiser.shortcuts', angular.toJson(shortcuts));
            }
        ...
        function saveShortcuts() {
            ...
            $cookies.put('techdiser.shortcuts', angular.toJson(vm.shortcuts));
    ...
    /** @ngInject */
    function msbMenuShortcutsDirective() {
        return {
            restrict: 'E',
            scope: {},
            require: 'msbMenuShortcuts',
            controller: 'msbMenuShortcutsDirectiveController as MsbMenuShortcuts',
            bindToController: {},
            templateUrl: 'app/common/directives/menu-shortcuts/menu-shortcuts.html',
            compile: function (tElement) {
                // Add class
                tElement.addClass('msb-shortcuts');

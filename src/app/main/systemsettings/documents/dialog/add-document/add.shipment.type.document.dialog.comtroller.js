(function () {
    ...
    angular
        ...
        .controller('DocumentSetupDialogController', DocumentSetupDialogController);

    function DocumentSetupDialogController(commonApiService, $mdDialog, ShipmentDocumentDef, TypeDocument, IsNew, utilService, PRIMARY_COLUMN_NAME) {
                ...
                if (typeDocument && vm.shipmentDocuments) {
                    ...
                    if (!vm.found) {
                        ...
                        var typeDocumentObj = {
                            ...
                            "preparedBy": typeDocument.preparedBy,
                            "issuedBy": typeDocument.issuedBy,

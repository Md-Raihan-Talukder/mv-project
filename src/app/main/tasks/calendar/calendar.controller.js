(function () {
    ...
    function CalendarController($mdDialog, $document) {
        ...
        function dayRender(date, cell) {
            ...
            if (date._d.toString().indexOf('Fri') > -1) {
                cell.addClass("md-red-200-bg");
            }
        ...
        function showEventDetailDialog(calendarEvent, e) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/main/tasks/calendar/dialogs/event-detail/event-detail-dialog.html',
        ...
        function showEventFormDialog(type, calendarEvent, start, end, e) {
            ...
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/main/tasks/calendar/dialogs/event-form/event-form-dialog.html',
                parent: angular.element($document.body),
                targetEvent: e,
                clickOutsideToClose: true,
                locals: {

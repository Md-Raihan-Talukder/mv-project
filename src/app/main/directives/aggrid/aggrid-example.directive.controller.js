//Change bower.json of agGrid's main to following
// "main": [
//    "dist/ag-grid.js",
//    "dist/ag-grid.css",        
...
(function () {
    ...
    angular
        ...
        .controller('AgGridExampleDirectiveController', AgGridExampleDirectiveController);

    /** @ngInject */
    function AgGridExampleDirectiveController($scope) {
        var vm = this;
        ...
        function skillsCellRenderer(params) {
            ...
            IT_SKILLS.forEach(function (skill) {
                if (data && data.skills[skill]) {
                    skills.push('<img src="/assets/images/aggrid/html5.png" width="16px" title="' + skill + '" />');
                }
            });
            return skills.join(' ');
        }
        ...
        function countryCellRenderer(params) {
            var flag = "<img border='0' width='15' height='10' style='margin-bottom: 2px' src='/assets/images/aggrid/gb.png'>";

(function () {
    ...
    /** @ngInject */
    function DashboardProjectController(utilService, $rootScope, $scope, $interval, $mdSidenav, DashboardData) {
        var vm = this;
        ...
        vm.widget5 = {
            ...
            init: function () {
                ...
                setTimeout(function () {
                    // saveSvgAsPng(document.getElementById("testSvg").querySelector("svg"), "diagram.png");

                    svgAsDataUri(document.getElementById("testSvg").querySelector("svg"), {}, function (uri) {
                        vm.emptyImage = uri;
                    });
